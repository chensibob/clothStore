    ...
    <div>
        ...
        <Form ref="formNewSoldNote" :model="formNewSoldNote" :label-width="80" :rules="ruleNewSoldNote" inline>
            ...
            <Form-item label="数量" prop="amount">
                <Input v-model="formNewSoldNote.amount" placeholder="请输入"></Input>
            </Form-item>

            <Form-item label="优惠价格" prop="preferentialPrice">
                <Input v-model="formNewSoldNote.preferentialPrice" placeholder="请输入"></Input>
            </Form-item>

            <Form-item label="实际收银" prop="cash">
                <Input v-model="formNewSoldNote.cash" placeholder="请输入"></Input>
            </Form-item>

            <Form-item label="下单时间" prop="date">
                <Input v-model="formNewSoldNote.date" placeholder="请输入"></Input>
            </Form-item>
